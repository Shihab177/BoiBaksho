  ...
  return (
   <motion.div>
    ...
    >
      ...
      <p className="text-2xl mb-2 text-[24px] dark:text-white">Oops! Page not found.</p>
      <p className="text-gray-600 mb-6 text-[24px] dark:text-white">The page you're looking for doesn't exist.</p>
      <button
        onClick={goHome}
