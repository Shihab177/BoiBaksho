...
const TopBook = () => {
    return (
        <div className='md:container  mx-auto my-15'>
            <h1 className='text-[36px]  font-bold text-center'>Top Book Categories</h1>
            <div className="bg-white mt-5 max-h-80 rounded-sm p-5 shadow-md">
                <div className="grid gap-4 md:grid-cols-4 grid-cols-2 ">
                    <div className="border flex items-center gap-2 text-[18px] font-semibold border-gray-200 shadow-md rounded-md ">
